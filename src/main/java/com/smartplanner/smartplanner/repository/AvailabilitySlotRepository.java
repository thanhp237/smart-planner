...
public interface AvailabilitySlotRepository extends JpaRepository<AvailabilitySlot, Integer> {
    ...
    List<AvailabilitySlot> findByUserIdAndActiveTrueOrderByDayOfWeekAscStartTimeAsc(Integer userId);
    List<AvailabilitySlot> findByUserIdAndDayOfWeekAndActiveTrueOrderByStartTimeAsc(Integer userId, Short dayOfWeek);
